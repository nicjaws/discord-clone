...
var CUIAutoComplete = function CUIAutoComplete(props) {
  ...
  return React.createElement(layout.Stack, null, React.createElement(formControl.FormLabel, Object.assign({}, getLabelProps({})), label), selectedItems && React.createElement(layout.Stack, {
    spacing: 2,
    isInline: true,
    flexWrap: 'wrap'
  ...
  }), ' ', "\u2193", ' ')), React.createElement(layout.Box, {
    pb: 4,
    mb: 4
